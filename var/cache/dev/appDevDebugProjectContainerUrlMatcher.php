...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/cv') && preg_match('#^/cv(?:/(?P<name>[^/]++)(?:/(?P<firstname>[^/]++))?)?$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'homepage')), array (  'name' => 'Florent',  'firstname' => 'Coquil',  '_controller' => 'AppBundle\\Controller\\DefaultController::indexAction',));
        }
